...
var etaque$elm_form$Form$Field$group = etaque$elm_form$Form$Tree$group;
var etaque$elm_form$Form$Tree$List = function (a) {
	return {$: 'List', a: a};
};
var etaque$elm_form$Form$Field$list = etaque$elm_form$Form$Tree$List;
...
var author$project$Model$initialFields = _List_fromArray(
	[
		_Utils_Tuple2(
		'name',
		etaque$elm_form$Form$Field$string('hey')),
		_Utils_Tuple2(
		'profile',
		etaque$elm_form$Form$Field$group(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'age',
					etaque$elm_form$Form$Field$string('33'))
				]))),
		_Utils_Tuple2(
		'todos',
		etaque$elm_form$Form$Field$list(
			_List_fromArray(
				[
					etaque$elm_form$Form$Field$group(
					_List_fromArray(
						[
							...
							_Utils_Tuple2(
							'label',
							etaque$elm_form$Form$Field$string('Remember the milk'))
						]))
				])))
	]);
var author$project$Model$User = F6(
	function (name, email, admin, birthday, profile, todos) {
		return {admin: admin, birthday: birthday, email: email, name: name, profile: profile, todos: todos};
	});
var author$project$Model$AlreadyTaken = {$: 'AlreadyTaken'};
...
var author$project$Model$asyncCheck = F2(
	function (serverIsOk, s) {
		return serverIsOk ? etaque$elm_form$Form$Validate$succeed(s) : etaque$elm_form$Form$Validate$fail(
			etaque$elm_form$Form$Validate$customError(author$project$Model$AlreadyTaken));
	});
var author$project$Model$InvalidDate = {$: 'InvalidDate'};
var author$project$Model$Date = F3(
...
var author$project$Model$dateParser = A2(
	elm$parser$Parser$keeper,
	A2(
		elm$parser$Parser$keeper,
		A2(
			elm$parser$Parser$keeper,
			elm$parser$Parser$succeed(author$project$Model$Date),
			A2(
...
var etaque$elm_form$Form$Validate$customValidation = F3(
	function (validation, callback, validationField) {
		return A2(
			elm$core$Result$andThen,
			callback,
			validation(validationField));
...
var author$project$Model$validateDate = function () {
	var validateDayIsValid = F2(
		function (date, validationField) {
			return ((date.month > 12) || (date.month < 1)) ? elm$core$Result$Err(
				etaque$elm_form$Form$Error$value(
					etaque$elm_form$Form$Error$CustomError(author$project$Model$InvalidDate))) : (((date.day > 31) || (date.day < 1)) ? elm$core$Result$Err(
				etaque$elm_form$Form$Error$value(
					etaque$elm_form$Form$Error$CustomError(author$project$Model$InvalidDate))) : elm$core$Result$Ok(date));
		});
	var parseDate = function (text) {
		return A2(
			...
			elm$core$Basics$always(
				etaque$elm_form$Form$Error$value(
					etaque$elm_form$Form$Error$CustomError(author$project$Model$InvalidDate))),
			A2(elm$parser$Parser$run, author$project$Model$dateParser, text));
	};
	return A2(
		...
		A2(
			...
			validateDayIsValid,
			A2(etaque$elm_form$Form$Validate$customValidation, etaque$elm_form$Form$Validate$string, parseDate)));
}();
var author$project$Model$Profile = F5(
	function (website, role, superpower, age, bio) {
		return {age: age, bio: bio, role: role, superpower: superpower, website: website};
	});
var author$project$Model$Nope = {$: 'Nope'};
...
var author$project$Model$naturalInt = A2(
	...
	function (i) {
		return (i > 0) ? elm$core$Result$Ok(i) : elm$core$Result$Err(
			etaque$elm_form$Form$Validate$customError(author$project$Model$Nope));
	});
var author$project$Model$roles = _List_fromArray(
	['role1', 'role2']);
var author$project$Model$Flying = {$: 'Flying'};
var author$project$Model$InvalidSuperpower = {$: 'InvalidSuperpower'};
var author$project$Model$Invisible = {$: 'Invisible'};
var author$project$Model$validateSuperpower = A2(
	etaque$elm_form$Form$Validate$customValidation,
	etaque$elm_form$Form$Validate$string,
	function (s) {
		switch (s) {
			case 'flying':
				return elm$core$Result$Ok(author$project$Model$Flying);
			case 'invisible':
				return elm$core$Result$Ok(author$project$Model$Invisible);
			default:
				return elm$core$Result$Err(
					etaque$elm_form$Form$Validate$customError(author$project$Model$InvalidSuperpower));
		}
	});
...
var author$project$Model$validateUrl = function () {
	var urlRegex = A2(
		elm$core$Maybe$withDefault,
		elm$regex$Regex$never,
		elm$regex$Regex$fromString('^(https?://)'));
	return A2(
		etaque$elm_form$Form$Validate$andThen,
		etaque$elm_form$Form$Validate$format(urlRegex),
		etaque$elm_form$Form$Validate$string);
}();
...
var etaque$elm_form$Form$Error$NotIncludedIn = {$: 'NotIncludedIn'};
var etaque$elm_form$Form$Validate$includedIn = F3(
	function (items, s, validationField) {
		return A2(elm$core$List$member, s, items) ? elm$core$Result$Ok(s) : elm$core$Result$Err(
			etaque$elm_form$Form$Error$value(etaque$elm_form$Form$Error$NotIncludedIn));
	});
...
var etaque$elm_form$Form$Validate$map = F3(
	function (f, validation, validationField) {
		return A2(
			elm$core$Result$map,
			f,
			validation(validationField));
...
var author$project$Model$validateProfile = A2(
	...
	A2(
		etaque$elm_form$Form$Validate$andMap,
		A2(etaque$elm_form$Form$Validate$field, 'age', author$project$Model$naturalInt),
		A2(
			etaque$elm_form$Form$Validate$andMap,
			A2(etaque$elm_form$Form$Validate$field, 'superpower', author$project$Model$validateSuperpower),
			A2(
				etaque$elm_form$Form$Validate$andMap,
				A2(
					etaque$elm_form$Form$Validate$field,
					...
					A2(
						etaque$elm_form$Form$Validate$andThen,
						etaque$elm_form$Form$Validate$includedIn(author$project$Model$roles),
						etaque$elm_form$Form$Validate$string)),
				A2(
					etaque$elm_form$Form$Validate$andMap,
					A2(
						...
						etaque$elm_form$Form$Validate$oneOf(
							_List_fromArray(
								[
									A2(
									etaque$elm_form$Form$Validate$map,
									function (_n0) {
										return elm$core$Maybe$Nothing;
									},
									etaque$elm_form$Form$Validate$emptyString),
									A2(etaque$elm_form$Form$Validate$map, elm$core$Maybe$Just, author$project$Model$validateUrl)
								]))),
					etaque$elm_form$Form$Validate$succeed(author$project$Model$Profile))))));
var author$project$Model$Todo = F2(
	function (done, label) {
...
var etaque$elm_form$Form$Validate$map2 = F3(
	function (func, v1, v2) {
		return A2(
			etaque$elm_form$Form$Validate$andMap,
			v2,
...
var author$project$Model$validateTodo = A3(
	etaque$elm_form$Form$Validate$map2,
	author$project$Model$Todo,
	A2(etaque$elm_form$Form$Validate$field, 'done', etaque$elm_form$Form$Validate$bool),
	A2(etaque$elm_form$Form$Validate$field, 'label', etaque$elm_form$Form$Validate$string));
...
var etaque$elm_form$Form$Validate$list = F2(
	function (validation, validationField) {
		if (validationField.$ === 'List') {
			var items = validationField.a;
			var results = A2(elm$core$List$map, validation, items);
			...
			var errors = A2(
				...
				A2(elm$core$List$indexedMap, indexedErrMaybe, results));
			return elm$core$List$isEmpty(errors) ? elm$core$Result$Ok(
				A2(elm$core$List$filterMap, elm$core$Result$toMaybe, results)) : elm$core$Result$Err(
				etaque$elm_form$Form$Tree$group(errors));
		} else {
...
var etaque$elm_form$Form$Validate$map3 = F4(
	function (func, v1, v2, v3) {
		return A2(
			etaque$elm_form$Form$Validate$andMap,
			v3,
			A3(etaque$elm_form$Form$Validate$map2, func, v1, v2));
	});
var etaque$elm_form$Form$Validate$map4 = F5(
...
var etaque$elm_form$Form$Validate$map6 = F7(
	function (func, v1, v2, v3, v4, v5, v6) {
		return A2(
			etaque$elm_form$Form$Validate$andMap,
			v6,
			A6(etaque$elm_form$Form$Validate$map5, func, v1, v2, v3, v4, v5));
	});
...
var author$project$Model$validate = A7(
	etaque$elm_form$Form$Validate$map6,
	...
	A2(
		...
		A2(
			etaque$elm_form$Form$Validate$andThen,
			author$project$Model$asyncCheck(true),
			etaque$elm_form$Form$Validate$email)),
	A2(
		etaque$elm_form$Form$Validate$field,
		'admin',
		A2(etaque$elm_form$Form$Validate$defaultValue, false, etaque$elm_form$Form$Validate$bool)),
	A2(etaque$elm_form$Form$Validate$field, 'date', author$project$Model$validateDate),
	A2(etaque$elm_form$Form$Validate$field, 'profile', author$project$Model$validateProfile),
	A2(
		etaque$elm_form$Form$Validate$field,
		'todos',
		etaque$elm_form$Form$Validate$list(author$project$Model$validateTodo)));
...
var author$project$Update$init = {
	form: A2(etaque$elm_form$Form$initial, author$project$Model$initialFields, author$project$Model$validate),
	userMaybe: elm$core$Maybe$Nothing
};
		...
		if (msg.$ === 'NoOp') {
			...
			if ((_n1.a.$ === 'Submit') && (_n1.b.$ === 'Just')) {
				...
				return _Utils_update(
					model,
					{
						userMaybe: elm$core$Maybe$Just(user)
					});
			} else {
				return _Utils_update(
					model,
					{
						form: A3(etaque$elm_form$Form$update, author$project$Model$validate, formMsg, form)
					});
			}
		}
	});
var author$project$Model$FormMsg = function (a) {
	return {$: 'FormMsg', a: a};
};
var author$project$Model$superpowers = _List_fromArray(
	['flying', 'invisible']);
...
var etaque$elm_form$Form$RemoveItem = F2(
	function (a, b) {
		return {$: 'RemoveItem', a: a, b: b};
	});
...
var author$project$View$todoItemView = F2(
	function (form, i) {
		var labelField = A2(
			etaque$elm_form$Form$getFieldAsString,
			'todos.' + (elm$core$String$fromInt(i) + '.label'),
			form);
		return _List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						'input-group' + author$project$View$Bootstrap$errorClass(labelField.liveError))
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								A2(
								etaque$elm_form$Form$Input$checkboxInput,
								A2(
									etaque$elm_form$Form$getFieldAsBool,
									'todos.' + (elm$core$String$fromInt(i) + '.done'),
									form),
								_List_Nil)
							])),
						A2(
							...
							[
								...
								_List_fromArray(
									[
										...
										A2(etaque$elm_form$Form$RemoveItem, 'todos', i)),
...
var author$project$View$Bootstrap$colN = F2(
	function (i, content) {
		return A2(
			elm$html$Html$div,
			_List_fromArray(
...
var etaque$elm_form$Form$Append = function (a) {
	return {$: 'Append', a: a};
};
var etaque$elm_form$Form$getListIndexes = F2(
	function (path, _n0) {
		var model = _n0.a;
		var length = A2(
			elm$core$Maybe$withDefault,
			...
			A2(
				elm$core$Maybe$map,
				A2(elm$core$Basics$composeR, etaque$elm_form$Form$Tree$asList, elm$core$List$length),
				A2(etaque$elm_form$Form$getFieldAt, path, model)));
		return A2(elm$core$List$range, 0, length - 1);
	});
var author$project$View$todosView = function (form) {
	var allTodos = A2(
		elm$core$List$concatMap,
		author$project$View$todoItemView(form),
		A2(etaque$elm_form$Form$getListIndexes, 'todos', form));
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				A2(
				author$project$View$Bootstrap$colN,
				3,
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								elm$html$Html$Events$onClick(
								etaque$elm_form$Form$Append('todos')),
...
var author$project$View$Bootstrap$formGroup = F3(
	function (label_, maybeError, inputs) {
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					A2(author$project$View$Bootstrap$colN, 5, inputs),
					A2(
					author$project$View$Bootstrap$colN,
					4,
					_List_fromArray(
...
var author$project$View$Bootstrap$dateGroup = F2(
	function (label_, state) {
		return A3(
			author$project$View$Bootstrap$formGroup,
			label_,
			...
			_List_fromArray(
				[
					A5(
					etaque$elm_form$Form$Input$baseInput,
					'date',
					etaque$elm_form$Form$Field$String,
					etaque$elm_form$Form$Text,
					state,
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('form-control'),
...
var etaque$elm_form$Form$Radio = {$: 'Radio'};
var etaque$elm_form$Form$Input$radioInput = F3(
	function (value, state, attrs) {
		var formAttrs = _List_fromArray(
			[
				elm$html$Html$Attributes$type_('radio'),
				elm$html$Html$Attributes$name(state.path),
				...
				A2(
					...
					A2(
						elm$core$Basics$composeR,
						etaque$elm_form$Form$Field$String,
						A2(etaque$elm_form$Form$Input, state.path, etaque$elm_form$Form$Radio)),
...
var author$project$View$Bootstrap$radioGroup = F3(
	function (options, label_, state) {
		var item = function (_n0) {
			var v = _n0.a;
			var l = _n0.b;
			return A2(
				elm$html$Html$label,
				...
				_List_fromArray(
					[
						A3(etaque$elm_form$Form$Input$radioInput, v, state, _List_Nil),
		...
		return A3(
			...
			label_,
			state.liveError,
			A2(elm$core$List$map, item, options));
	});
...
var etaque$elm_form$Form$Input$textArea = F2(
	function (state, attrs) {
		var formAttrs = _List_fromArray(
			[
				elm$html$Html$Attributes$value(
...
var author$project$View$Bootstrap$textAreaGroup = F2(
	function (label_, state) {
		return A3(
			author$project$View$Bootstrap$formGroup,
			label_,
			...
			_List_fromArray(
				[
					A2(
					etaque$elm_form$Form$Input$textArea,
					state,
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('form-control'),
...
var etaque$elm_form$Form$getChangedFields = function (_n0) {
	var model = _n0.a;
	return model.changedFields;
};
var author$project$View$formView = function (form) {
	var superpowerOptions = A2(
		elm$core$List$map,
		function (i) {
			return _Utils_Tuple2(
				i,
				elm$core$String$toUpper(i));
		},
		author$project$Model$superpowers);
	var roleOptions = A2(
		elm$core$List$cons,
		_Utils_Tuple2('', '--'),
		A2(
			...
			author$project$Model$roles));
	var disableSubmit = elm$core$Set$isEmpty(
		etaque$elm_form$Form$getChangedFields(form));
	var submitBtnAttributes = _Utils_ap(
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						_Utils_Tuple2('btn btn-primary', true),
						_Utils_Tuple2('disabled', disableSubmit)
					]))
			]),
		disableSubmit ? _List_fromArray(
			[
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2(etaque$elm_form$Form$getFieldAsBool, 'admin', form)),
				A2(
				author$project$View$Bootstrap$dateGroup,
				elm$html$Html$text('Date'),
				A2(etaque$elm_form$Form$getFieldAsString, 'date', form)),
				A2(
				author$project$View$Bootstrap$textGroup,
				elm$html$Html$text('Website'),
				A2(etaque$elm_form$Form$getFieldAsString, 'profile.website', form)),
				A3(
				author$project$View$Bootstrap$selectGroup,
				roleOptions,
				elm$html$Html$text('Role'),
				A2(etaque$elm_form$Form$getFieldAsString, 'profile.role', form)),
				A3(
				author$project$View$Bootstrap$radioGroup,
				superpowerOptions,
				elm$html$Html$text('Superpower'),
				A2(etaque$elm_form$Form$getFieldAsString, 'profile.superpower', form)),
				A2(
				author$project$View$Bootstrap$textGroup,
				elm$html$Html$text('Age'),
				A2(etaque$elm_form$Form$getFieldAsString, 'profile.age', form)),
				A2(
				author$project$View$Bootstrap$textAreaGroup,
				elm$html$Html$text('Bio'),
				A2(etaque$elm_form$Form$getFieldAsString, 'profile.bio', form)),
				author$project$View$todosView(form),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Events$onClick(
								etaque$elm_form$Form$Reset(author$project$Model$initialFields)),
	...
	return A2(
		...
		_List_fromArray(
			[
				A2(
				elm$html$Html$map,
				author$project$Model$FormMsg,
				author$project$View$formView(form)),
				function () {
				if (userMaybe.$ === 'Just') {
...
var author$project$Main$main = elm$browser$Browser$sandbox(
	{init: author$project$Update$init, update: author$project$Update$update, view: author$project$View$view});
